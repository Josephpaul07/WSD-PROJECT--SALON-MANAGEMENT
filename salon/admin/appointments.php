                      ...
                      <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                          ...
                          <?php foreach ($rec_list as $key => $row) { ?>
                            <tr class="odd gradeX">
                              ...
                              <td>
                              <?php if ( $row['status'] == 1 )  {?>  
                              <a href="<?= base_url('admin/appointments.php?apporve='.$row['id'] ) ?>" class="btn btn-sm btn-success"> <i class="fa fa-check"></i> Approve </a>
                              <a href="<?= base_url('admin/appointments.php?reject='.$row['id'] ) ?>" class="btn btn-sm btn-danger"> <i class="fa fa-close"></i> Reject </a>
